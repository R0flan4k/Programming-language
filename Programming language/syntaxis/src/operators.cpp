...
Operator OPERATORS_ARRAY[] = {
    ...
    create_operator("scaaplaa", len(sizeof("scaaplaa")), OPERATORS_EQUAL),
    ...
    create_operator("ttihmmr",  len(sizeof("ttihmmr")),  OPERATORS_SQUARE_ROOT),
    create_operator("paar",     len(sizeof("paar")),     OPERATORS_ASSIGMENT),
